...
namespace Narupa.Visualisation.Editor
{
    ...
    internal static class VisualiserPrefabEnvironment
    {
        ...
        private static async Task<Plugins.Narupa.Frame.Frame> ImportCifFile(
            string filename,
        ...
        {
            public FrameSource(Plugins.Narupa.Frame.Frame frame)
            {
                CurrentFrame = frame;
            }

            public Plugins.Narupa.Frame.Frame CurrentFrame { get; }
