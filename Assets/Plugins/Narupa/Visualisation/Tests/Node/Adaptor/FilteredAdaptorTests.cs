...
using Plugins.Narupa.Core.Collections;
using UnityEngine;
...
namespace Narupa.Visualisation.Tests.Node.Adaptor
{
    public class FilteredAdaptorDynamicPropertyTests
    {
        ...
        private Plugins.Narupa.Frame.Frame emptyFrame;
        private Plugins.Narupa.Frame.Frame frameWithPositions;
        ...
        public void Setup()
        {
            ...
            emptyFrame = new Plugins.Narupa.Frame.Frame();

            frameWithPositions = new Plugins.Narupa.Frame.Frame
            {
