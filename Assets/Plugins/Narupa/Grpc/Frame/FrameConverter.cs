...
namespace Narupa.Grpc.Frame
{
    ...
    public static class FrameConverter
    {
        ...
        /// </param>
        public static (Plugins.Narupa.Frame.Frame Frame, FrameChanges Update) ConvertFrame(
            [NotNull] FrameData data,
            [CanBeNull] Plugins.Narupa.Frame.Frame previousFrame = null)
        {
            var frame = previousFrame != null
                            ? Plugins.Narupa.Frame.Frame.ShallowCopy(previousFrame)
                            : new Plugins.Narupa.Frame.Frame();
