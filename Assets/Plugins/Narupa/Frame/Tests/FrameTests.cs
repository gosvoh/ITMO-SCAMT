...
namespace Narupa.Frame.Tests
{
    public class FrameTests
    {
        ...
        {
            var originalFrame = new Plugins.Narupa.Frame.Frame()
            {
            ...
            var clonedFrame = Plugins.Narupa.Frame.Frame.ShallowCopy(originalFrame);
        ...
        public void ParticlesIteration()
        {
            ...
            var frame = new Plugins.Narupa.Frame.Frame()
            {
